...
const ConfirmedRide = (props) => {
  return (
    <div>
      ...
      <h3 className="mb-5 font-semibold text-2xl">Choose your Vehicle</h3>
      ...
      <div className="flex gap-2 justify-between items-center flex-col">
        ...
        <div className="w-full mt-5">
          <div className="flex gap-2 p-3 items-center border-b-2 border-gray-200">
            ...
            <div>
              ...
              <p className="text-sm -mt-1 text-gray-600">New Laxmi Nagar,Gondia</p>
            </div>
          </div>
          <div className="flex gap-2 p-3 items-center border-b-2 border-gray-200">
        ...
        }}className="w-full mt-5 bg-green-600 rounded-2xl p-2 text-white font-semibold">
          Confirm
        </button>
      </div>
    </div>
