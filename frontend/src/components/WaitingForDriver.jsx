...
<div>
        ...
        <div className="flex gap-2 justify-between items-center flex-col">
            ...
            <div className="flex gap-2 p-3 items-center border-b-2 border-gray-200">
                ...
                <div>
                <h5 className="text-lg font-medium">Third wave Coffee</h5>
                <p className="text-sm -mt-1 text-gray-600">Railtoly,Gondia</p>
                </div>
            </div>
            <div className="flex gap-2 p-3 items-center">
                <i className="ri-cash-line"></i>
                <div>
                <h5 className="text-lg font-medium">200/-</h5>
