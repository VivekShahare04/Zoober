  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      ...
      <div ref={vehiclePanelRef} className='fixed bottom-0 translate-y-full bg-white w-full z-10 px-3 py-10 pt-14'>
        <VehiclePanel  setConfirmedVehiclePanel={setConfirmedVehiclePanel} setVehiclePanel={setVehiclePanel}/>
      </div>
      <div ref={confirmedvehiclepanelRef} className='fixed bottom-0 translate-y-full bg-white w-full z-10 px-3 py-10 pt-14'>
        <ConfirmedRide setConfirmedVehiclePanel={setConfirmedVehiclePanel} setVehicleFound={setVehicleFound}/>
      </div>
      <div ref={vehicleFoundRef} className='fixed bottom-0 translate-y-full bg-white w-full z-10 px-3 py-10 pt-14'>
        <LookingForDriver setVehicleFound={setVehicleFound}/>
      </div>
      <div ref={waitingfordriverRef}className='fixed bottom-0 bg-white w-full z-10 px-3 py-10 pt-14'>
