    ...
    return (
        ...
        <div>
            ...
            <div className='flex gap-4 mb-3'>
                <input
                required
                className='bg-[#eeeeee] w-1/2 rounded-lg px-2 py-2 border  text-xs placeholder:text-base'
                type="text"
            ...
            <input
                ...
                className='bg-[#eeeeee] mb-3 rounded-lg px-2 py-2 border w-full text-xs placeholder:text-base'
                type="email"
            ...
            <div className='flex gap-4 mb-3'>
                <input
                required
                className='bg-[#eeeeee] w-1/2 rounded-lg px-3 py-2 border text-xs placeholder:text-base'
                type="text"
            ...
            <button
                className='bg-[#111] text-white font-semibold  rounded-lg px-3 py-2 w-full text-lg placeholder:text-base'
