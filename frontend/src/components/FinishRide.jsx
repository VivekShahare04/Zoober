        ...
        <div>
            ...
            <div className='flex items-center justify-between p-4 border-2 bg-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium'>Vivek Shahare</h2>
                </div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-10 w-full'>
                    ...
                    <Link to='/captain-home'
                        className='w-full mt-8 flex  text-lg justify-center bg-green-600 text-white font-semibold p-3 rounded-lg'>Finish Ride</Link>
                </div>
            </div>
        </div>
    )
