...
const CaptainLogin = () => {
    ...
    return (
        <div className='p-7 flex flex-col justify-between h-screen'>
            ...
            <p className='text-center'>Join as provider? <Link to='/captain-signup' className='text-center text-blue-600 '>Register as Captain</Link></p>
            </div>
            <div>
                <Link to='/login' className='bg-[#273f43] flex item-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 border w-full text-lg placeholder:text-base'>Sign in as User</Link>
            </div>
        </div>
    )
}
